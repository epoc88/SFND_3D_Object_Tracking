...
int main(int argc, const char *argv[])
{
    ...
    if (csvFlag)
        cout << "ImgNum, KptDetector, TotalNumOfKpts, DetectionTime, DescriptorType, ExtractionTime, ttcLidar, kptMatches, ttcCamera" << endl;

  
    vector<string> detectorTypes = {"SHITOMASI", "HARRIS", "FAST", "BRISK", "ORB", "AKAZE", "SIFT"};
    vector<string> descriptorTypes = {"BRISK", "BRIEF", "ORB", "FREAK", "AKAZE", "SIFT"};
  
  //  vector<string> detectorTypes = {  "ORB", "AKAZE", "SIFT"};   //for testing
  //  vector<string> descriptorTypes = { "SIFT","ORB",  "AKAZE"};  //for testing
